    ...
    <PageShell>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="space-y-6">
          {loading ? (
            <>
              <div className="rounded-xl border bg-card p-5"><Skeleton className="h-5 w-32 mb-4" /><div className="space-y-2">{Array.from({ length: 3 }).map((_, i) => <Skeleton key={i} className="h-12 w-full" />)}</div></div>
              <div className="rounded-xl border bg-card p-5"><Skeleton className="h-5 w-32 mb-4" /><div className="space-y-2">{Array.from({ length: 4 }).map((_, i) => <Skeleton key={i} className="h-10 w-full" />)}</div></div>
            </>
          ) : (
            <>
              <Fade delay={0.15}>
